...
export default function AboutPage() {
  const { about, dataLoading } = useData();
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(to bottom, rgba(5, 8, 16, 0.7), rgba(10, 14, 26, 0.9)), url(/images/about-hero.jpg)',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed">{missionText}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">{whoWeAreText1}</p>
              <p className="text-gray-300 text-lg leading-relaxed">{whoWeAreText2}</p>
            </div>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(to bottom, rgba(5, 8, 16, 0.8), rgba(10, 14, 26, 0.9)), url(/images/community-bg.jpg)',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
        }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
            Connect with fellow space explorers, share your sightings, participate in events, and stay
            updated with the latest astronomical news.
          </p>
